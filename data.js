...
window.I18N = {
    es: {
        brandSub:'VALOR · MUNDIAL 2026',
        navToday:'Hoy', navValue:'Valor', navCombos:'Combinadas', navRecord:'Récord', navHow:'Cómo funciona',
        searchPh:'Buscar selección o partido…',
        updated:'Actualizado hoy', autoUpdate:'Se actualiza solo cada mañana',
        heroEyebrow:'CUOTAS CON VALOR · MUNDIAL 2026',
        heroTitle1:'EL VALOR', heroTitle2:'DEL MUNDIAL.',
        heroLead:'Cada mañana comparamos las cuotas de ganador de las principales casas con la probabilidad real de nuestro modelo. Te decimos qué apostar y en qué casa está la mejor cuota.',
    ...
    en: {
        ...
        heroEyebrow:'VALUE ODDS · WORLD CUP 2026',
        heroTitle1:'WORLD CUP', heroTitle2:'VALUE.',
        heroLead:'Every morning we compare the match-winner odds from the top books with our model\u2019s true probability. We tell you what to back and which book has the best price.',
        ...
        disc:'MUNDIAL VALUE is a statistical analysis tool for informational purposes. It does not guarantee outcomes or profit. Value is our model\u2019s estimate. Odds change; always verify at the book before betting. 18+. Responsible gaming.',
