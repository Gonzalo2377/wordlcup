            ...
            <header className="nav">
                <div className="nav__inner">
                    <a className="brand" href="#" onClick={(e)=>{e.preventDefault(); go({view:'home'});}}>
                        ...
                        <span>
                            <span className="brand__name">MUNDIAL<b>VALUE</b></span>
...
function Ticker() {
    const items = [
        ['GRUPO B','ESP','CRO','—'],['GRUPO C','ARG','MEX','—'],['GRUPO D','FRA','USA','—'],
        ['GRUPO E','POR','MAR','—'],['GRUPO F','BRA','COL','—'],['GRUPO A','NED','JPN','—'],
    ];
...
function Footer({ t, go }) {
    return (
        <footer className="footer">
            <div className="footer__inner">
                <div style={{ maxWidth:280 }}>
                    <div className="brand" style={{ marginBottom:14 }}>
                        <span className="brand__mark">{Icon.ball({ style:{width:22,height:22} })}</span>
                        <span><span className="brand__name">MUNDIAL<b>VALUE</b></span></span>
                    </div>
            ...
            <div className="footer__legal"><b>+18 · {t.discTitle}</b> MUNDIAL VALUE © 2026 · {t.builtWith}</div>
        </footer>
    );
}
