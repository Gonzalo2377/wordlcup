    ...
    return (
        <div className="vcard" onClick={()=>go({ view:'match', id:m.id })}>
            ...
            <div className="vc-team">
                ...
                <span className="vc-team__rec">FIFA #{home.fifa}</span>
            </div>
            <div className="vc-team">
                <Flag team={away} /><span className="vc-team__name">{away.name}</span>
                <span className="vc-team__rec">FIFA #{away.fifa}</span>
            </div>
                ...
                <div className="match-hero__inner">
                    ...
                    <div className="mh-teams">
                        <div className="mh-team">
                            ...
                            <div><div className="mh-team__name">{home.name}</div><div className="mh-team__rec">FIFA #{home.fifa} · {home.conf}</div></div>
                        </div>
                        ...
                        <div className="mh-team">
                            ...
                            <div><div className="mh-team__name">{away.name}</div><div className="mh-team__rec">FIFA #{away.fifa} · {away.conf}</div></div>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid--main">
                        ...
                        <div>
                            ...
                            <div className="panel panel--pad" style={{ marginTop:16 }}>
                                ...
                                <div style={{ fontFamily:'var(--font-mono)', fontSize:'.66rem', color:'var(--muted)', letterSpacing:'.04em', marginTop:8 }}>{t.mdMethod}</div>
                            </div>
